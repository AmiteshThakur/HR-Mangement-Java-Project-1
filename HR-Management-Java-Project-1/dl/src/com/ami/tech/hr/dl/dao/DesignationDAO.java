...
public class DesignationDAO implements DesignationDAOInterface {
  ...
  public void add(DesignationDTOInterface designationDTO) throws DAOException {
    if (designationDTO == null) throw new DAOException(
      "DesignationDTO is null"
    );
    ...
    try {
      ...
      //we added code and title in the file....
      // now we have to update the lastgeneratedcode and recordcoutn , which is in the starting of the file....
    ...
    throws DAOException {
		if (designationDTO == null) throw new DAOException(
		  ...
		  if (title.length() == 0) throw new DAOException(
			...
			randomAccessFile.readLine();
			randomAccessFile.readLine();
			while(randomAccessFile.readLine()){
				fCode=Integer.parseInt(randomAccessFile.readLine());
  ...
  public  Set<DesignationDTOInterface> getAll() throws DAOException {
    Set<DesignationDTOInterface> designations = new TreeSet<DesignationDTOInterface>();
  ...
  public DesignationDTOInterface getByCode(int code) throws DAOException {
    ...
    try {
      File file = new File(FILE_NAME);
      if (file.exists() == false) throw new DAOException(
        "Invalid code :" + code
      );
      RandomAccessFile randomAccessFile;
      randomAccessFile = new RandomAccessFile(file, "rw");
  ...
  public DesignationDTOInterface getByTitle(String title) throws DAOException {
    if (title == null || title.trim().length() == 0) throw new DAOException(
      "Invalid Title: " + title
    );
    title = title.trim();
    try {
